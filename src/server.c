...
void* create_librarians(void*arg){
    FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/librarians.dat","wb");
    num_librarians=0;
...
//    printf("hoyaa1");
    if(argstr==NULL || argstr[0]!='c'){
        FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/librarians.dat", "rb");
        if(fp==NULL)perror("ISNULL\n");
...
void* create_clients(void*arg){
    FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/clients.dat","wb");
    num_clients=0;
    if(fp==NULL)perror("ISNULL\n");
...
void* initialize_clients(void*arg){
    ...
    if(argstr==NULL || argstr[2]!='c'){
        FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/clients.dat", "rb");
        if(fp==NULL)perror("ISNULL\n");
...
void* write_books(void*arg){
    pthread_mutex_lock(&library_mutex);
    FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/books.dat","wb");
    if(fp==NULL)perror("ISNULL\n");
    printf("%d\n",num_books);
...
//    printf("arg:%s\n",argstr);
    if(argstr==NULL || argstr[1]!='c'){
        FILE * fp = fopen("Users/akhilballa/Documents/OS/OS mini project/data/books.dat", "rb");
        if(fp==NULL)perror("ISNULL\n");
